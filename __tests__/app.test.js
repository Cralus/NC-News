...
describe("/api/users get request", () => {
    test("should respond with a staus of 200 and an array of 4 user objects", () => {
      return request(app)
        .get("/api/users")
        .expect(200)
        .then(({ body: { users } }) => {
    ...
    test("should respond with a status of 200 and an array of user objects each with a username property", () => {
      return request(app)
        .get("/api/users")
        .expect(200)
        .then(({ body: { users } }) => {
